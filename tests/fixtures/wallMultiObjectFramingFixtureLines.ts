...
export const MULTI_OBJECT_LIVE_EXPECTED = {
  ...
  openings: {
    ...
    "O-002": {
      ...
      jackStuds: null,
      roughSill: 4,
      explicitKingStudCount: false,
      cripplesAbove: 2,
      cripplesBelow: 2,
    },
    "O-003": { kingStuds: 2, jackStuds: null, roughSill: null, explicitKingStudCount: false },
  },
  headers: {
    "SM-HDR-001": 6,
    "SM-HDR-002": 8,
