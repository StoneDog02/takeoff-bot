...
} from "../calculators/createOpeningCrippleLayoutAssumption.js";
import {
  createOpeningKingStudCountAssumption,
  KING_STUD_COUNT_DEFAULT,
} from "../calculators/createOpeningKingStudCountAssumption.js";
import { createOpeningRoughSillSizeAssumption } from "../calculators/createOpeningRoughSillSizeAssumption.js";
...
const REGISTRY_ENTRIES: readonly AssumptionRegistryEntry[] = [
  {
    ...
    isEligible: () => true,
    createAssumption: (context, reviewItemId) =>
      createOpeningKingStudCountAssumption(context.objectId, reviewItemId),
  },
  {
  ...
  },
  {
    ...
    isEligible: () => true,
    createAssumption: (context, reviewItemId) =>
      createOpeningCrippleLayoutAssumption(context.objectId, reviewItemId, [
...
export function consultAssumptionRegistry(input: {
  ...
  const assumption = entry.createAssumption(input.context, input.reviewItemId);
