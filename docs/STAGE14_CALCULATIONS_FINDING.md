...
**Primary files:**
- Stage wiring: [`createFramingStages.ts`](../src/scopes/framing/stages/createFramingStages.ts) (order 14)
- Coordinator: [`calculation-coordinator.ts`](../src/scopes/framing/calculators/calculation-coordinator.ts)
- Calculators: [`calculateWallFraming.ts`](../src/scopes/framing/calculators/calculateWallFraming.ts), [`calculateOpeningFraming.ts`](../src/scopes/framing/calculators/calculateOpeningFraming.ts), [`calculateStructuralMembers.ts`](../src/scopes/framing/calculators/calculateStructuralMembers.ts), [`calculateSheathing.ts`](../src/scopes/framing/calculators/calculateSheathing.ts), [`calculateFloorFraming.ts`](../src/scopes/framing/calculators/calculateFloorFraming.ts), [`calculateRoofFraming.ts`](../src/scopes/framing/calculators/calculateRoofFraming.ts), [`calculateFasteners.ts`](../src/scopes/framing/calculators/calculateFasteners.ts)
- Helpers: [`netStudDeduction.ts`](../src/scopes/framing/calculators/netStudDeduction.ts), [`isQuantityInputResolved.ts`](../src/scopes/framing/calculators/isQuantityInputResolved.ts), [`isQuantityBlocked.ts`](../src/scopes/framing/calculators/isQuantityBlocked.ts)
- Assumptions: [`assumptionRegistry.ts`](../src/scopes/framing/claims/assumptionRegistry.ts), [`collectPendingClaims.ts`](../src/scopes/framing/claims/collectPendingClaims.ts)
- Quantity contracts: [`claimContracts.ts`](../src/scopes/framing/claims/claimContracts.ts), [`rule-ids.ts`](../src/scopes/framing/validators/rule-ids.ts)
- Material schema: [`material.schema.ts`](../src/scopes/framing/schemas/material.schema.ts)
- Beckstead: `artifacts/b2.2m.4/runs/beckstead-audit-b/framing/14-calculations.json`; fixture path in [`beckstead-m6-frozen-pipeline.test.ts`](../tests/scopes/framing/beckstead-m6-frozen-pipeline.test.ts)
...
[`beckstead-m6-frozen-pipeline.test.ts`](../tests/scopes/framing/beckstead-m6-frozen-pipeline.test.ts) on replay fixture with linked crawl area:
