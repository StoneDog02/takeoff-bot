...
| Claim candidacy machinery | Deleted; assumption registry moved to `src/framing/assumptions/` |
...
- `tests/framing/reset/reset-takeoff.test.ts` — pass (incl. Beckstead crawl 31/527)
