...
**Primary files:**
- Stage wiring: [`createFramingStages.ts`](../src/framing/stages/createFramingStages.ts) (order 15)
- Coordinator: [`confidence-coordinator.ts`](../src/framing/confidence/confidence-coordinator.ts)
- Object evaluation: [`evaluateObjectConfidence.ts`](../src/framing/confidence/evaluateObjectConfidence.ts)
- Takeoff evaluation: [`evaluateTakeoffConfidence.ts`](../src/framing/confidence/evaluateTakeoffConfidence.ts)
- Dimension rules: [`deriveDimensions.ts`](../src/framing/confidence/deriveDimensions.ts)
