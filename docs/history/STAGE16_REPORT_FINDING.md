...
**Primary files:**
- Stage wiring: [`createFramingStages.ts`](../src/framing/stages/createFramingStages.ts) (order 16)
- Report schema: [`framing-takeoff.schema.ts`](../src/framing/schemas/framing-takeoff.schema.ts)
- Material line schema: [`material.schema.ts`](../src/framing/schemas/material.schema.ts)
- Companion builder: [`buildFramingPackageProductState.ts`](../src/framing/observability/buildFramingPackageProductState.ts)
