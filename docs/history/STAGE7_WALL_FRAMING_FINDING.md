...
**Primary files:**
- Stage wiring: [`src/framing/stages/createFramingStages.ts`](../src/framing/stages/createFramingStages.ts) (orders 7, 13, 14)
- Resolver: [`src/framing/resolve/resolveWallFraming.ts`](../src/framing/resolve/resolveWallFraming.ts)
- Helpers: [`wallFramingPropertyPaths.ts`](../src/framing/resolve/wallFramingPropertyPaths.ts), [`convergeEvidenceByCanonicalObjectId.ts`](../src/framing/resolve/convergeEvidenceByCanonicalObjectId.ts), [`ids.ts`](../src/framing/resolve/ids.ts)
- Schemas: [`wall.schema.ts`](../src/framing/schemas/wall.schema.ts)
- Calculator: [`calculateWallFraming.ts`](../src/framing/calculate/calculateWallFraming.ts), [`netStudDeduction.ts`](../src/framing/calculate/netStudDeduction.ts)
- Validation consulted by calc: [`wall-framing.validator.ts`](../src/framing/validators/wall-framing.validator.ts), [`isQuantityBlocked.ts`](../src/framing/calculate/isQuantityBlocked.ts)
...
IDs ([`ids.ts`](../src/framing/resolve/ids.ts)):
...
Relevant wall validation impacts ([`validateWallFraming`](../src/framing/validators/wall-framing.validator.ts)):
