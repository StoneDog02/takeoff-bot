...
**Source of truth for stage wiring:** [`src/framing/stages/createFramingStages.ts`](../src/framing/stages/createFramingStages.ts) via [`PipelineRunner`](../src/core/pipeline/PipelineRunner.ts).
