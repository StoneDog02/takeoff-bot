...
**Primary files:**
- Stage wiring: [`createFramingStages.ts`](../src/scopes/framing/stages/createFramingStages.ts) (order 11)
- Resolver: [`resolveFloorFraming.ts`](../src/scopes/framing/resolvers/resolveFloorFraming.ts)
- Layout authority: [`floorLayoutAuthority.ts`](../src/scopes/framing/resolvers/floorLayoutAuthority.ts)
- Fragment/consolidation: [`floorFragmentConsolidation.ts`](../src/scopes/framing/resolvers/floorFragmentConsolidation.ts)
- Slab compatibility: [`floorAreaMaterialCompatibility.ts`](../src/scopes/framing/resolvers/floorAreaMaterialCompatibility.ts)
- Parent-system link: [`resolveFloorAreaParentSystem.ts`](../src/scopes/framing/resolvers/resolveFloorAreaParentSystem.ts)
- Property paths: [`floorFramingPropertyPaths.ts`](../src/scopes/framing/resolvers/floorFramingPropertyPaths.ts)
- Schema: [`floor-framing.schema.ts`](../src/scopes/framing/schemas/floor-framing.schema.ts)
- Stage 6 relationship emitters (not Stage 11): [`buildAreaSystemRelationshipEvidence.ts`](../src/scopes/framing/geometry/buildAreaSystemRelationshipEvidence.ts), [`buildConstructionSemanticRelationshipEvidence.ts`](../src/scopes/framing/geometry/buildConstructionSemanticRelationshipEvidence.ts)
- Calculator: [`calculateFloorFraming.ts`](../src/scopes/framing/calculators/calculateFloorFraming.ts)
- Validation: [`floor-framing.validator.ts`](../src/scopes/framing/validators/floor-framing.validator.ts)
- Beckstead fixtures/tests: [`becksteadM5FloorLayoutEvidence.ts`](../tests/fixtures/becksteadM5FloorLayoutEvidence.ts), [`beckstead-floor-layout-authority.test.ts`](../tests/scopes/framing/beckstead-floor-layout-authority.test.ts), [`beckstead-m5-frozen-pipeline.test.ts`](../tests/scopes/framing/beckstead-m5-frozen-pipeline.test.ts)
...
Stage 11 does **not** read wall framing, openings, compiled pages, `projectDictionary`, geometry artifacts, or structural members directly — despite [`floor-framing.spec.md`](../src/scopes/framing/specs/floor-framing.spec.md) listing those as consumed artifacts.
...
Documented in [`beckstead-floor-layout-authority.test.ts`](../tests/scopes/framing/beckstead-floor-layout-authority.test.ts) using [`buildBecksteadM5CrawlSpaceFloorEvidence()`](../tests/fixtures/becksteadM5FloorLayoutEvidence.ts) — applies **M.5 governance corrections** to M.4-shaped facts:
...
[`beckstead-pl-v1d-floor-wb-replay.test.ts`](../tests/scopes/framing/beckstead-pl-v1d-floor-wb-replay.test.ts): re-runs `buildConstructionSemanticRelationshipEvidence` on PL evidence → emits `parentSystemTag` for crawl bays → `resolveFloorFraming` links ≥2 crawl bays → floor joist lines emit (when artifact dir present).
