...
**Primary files:**
- Stage wiring: [`createFramingStages.ts`](../src/scopes/framing/stages/createFramingStages.ts) (orders 8, 9, 13, 14)
- Resolver: [`resolveOpenings.ts`](../src/scopes/framing/resolvers/resolveOpenings.ts)
- Helpers: [`openingPropertyPaths.ts`](../src/scopes/framing/resolvers/openingPropertyPaths.ts), [`applyWallOpeningBacklinks.ts`](../src/scopes/framing/resolvers/applyWallOpeningBacklinks.ts), [`ids.ts`](../src/scopes/framing/resolvers/ids.ts) (`createOpeningObjectId`)
- Schema: [`opening.schema.ts`](../src/scopes/framing/schemas/opening.schema.ts)
- Pre–Stage 8 geometry Evidence: [`buildOpeningEvidenceFromCompiledPages.ts`](../src/scopes/framing/geometry/buildOpeningEvidenceFromCompiledPages.ts), adopt/mark ownership
- Stage 9 headers: [`linkOpeningHeaderRelationships.ts`](../src/scopes/framing/resolvers/linkOpeningHeaderRelationships.ts)
- Calculator: [`calculateOpeningFraming.ts`](../src/scopes/framing/calculators/calculateOpeningFraming.ts)
- Assumptions: [`assumptionRegistry.ts`](../src/scopes/framing/claims/assumptionRegistry.ts)
- Validation: [`openings.validator.ts`](../src/scopes/framing/validators/openings.validator.ts)
