...
**Primary files:**
- Stage wiring: [`createFramingStages.ts`](../src/scopes/framing/stages/createFramingStages.ts) (order 9)
- Resolver: [`resolveStructuralMembers.ts`](../src/scopes/framing/resolvers/resolveStructuralMembers.ts)
- Authority pass: [`structuralMemberAuthority.ts`](../src/scopes/framing/resolvers/structuralMemberAuthority.ts)
- Header linking: [`linkOpeningHeaderRelationships.ts`](../src/scopes/framing/resolvers/linkOpeningHeaderRelationships.ts)
- Property paths: [`structuralMemberPropertyPaths.ts`](../src/scopes/framing/resolvers/structuralMemberPropertyPaths.ts)
- Schema: [`structural-member.schema.ts`](../src/scopes/framing/schemas/structural-member.schema.ts)
- Schedule Evidence (Stage 6): [`buildSemanticDefinitionEvidenceFromCompiledPages.ts`](../src/scopes/framing/geometry/buildSemanticDefinitionEvidenceFromCompiledPages.ts)
- Calculator: [`calculateStructuralMembers.ts`](../src/scopes/framing/calculators/calculateStructuralMembers.ts)
- Validation: [`structural-members.validator.ts`](../src/scopes/framing/validators/structural-members.validator.ts), [`openings.validator.ts`](../src/scopes/framing/validators/openings.validator.ts) (header reference)
