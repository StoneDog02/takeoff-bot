...
**Primary files:**
- Stage wiring: [`createFramingStages.ts`](../src/scopes/framing/stages/createFramingStages.ts) (order 13)
- Coordinator: [`validation-coordinator.ts`](../src/scopes/framing/validators/validation-coordinator.ts)
- Rule IDs: [`rule-ids.ts`](../src/scopes/framing/validators/rule-ids.ts)
- Blocking helper: [`isQuantityBlocked.ts`](../src/scopes/framing/calculators/isQuantityBlocked.ts)
- Input resolution gate: [`isQuantityInputResolved.ts`](../src/scopes/framing/calculators/isQuantityInputResolved.ts)
- Issue/result builders: [`buildValidationBatch.ts`](../src/scopes/framing/validators/buildValidationBatch.ts), [`createValidationIssue.ts`](../src/scopes/framing/validators/createValidationIssue.ts)
- Stage 14 coordinator: [`calculation-coordinator.ts`](../src/scopes/framing/calculators/calculation-coordinator.ts)
- Pending claims from blocks: [`collectPendingClaims.ts`](../src/scopes/framing/claims/collectPendingClaims.ts)
...
From [`isQuantityBlocked.ts`](../src/scopes/framing/calculators/isQuantityBlocked.ts):
